...
def registro():
    ...
    entrada_clave.pack()
    Label(ventana_registro, text="").pack()
    Button(ventana_registro, text="Registrarse", width=10, height=1, bg="DarkTurquoise", command = registro_usuario).pack() #BOTÓN "Registrarse"
...
def login():
    ...
    Label(ventana_login, text="Introduzca nombre de usuario y contraseña", bg= "DarkTurquoise").pack()
...
def registro_usuario():
    ...
    Label(ventana_registro, text="Registro completado con éxito", bg="White", font=("calibri", 11)).pack()
